<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PatientEdit.aspx.cs" Inherits="BloodBank.PatientEdit" %>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col text-center">
                                <img src="../Images/patient.png" width="64px" />
                                <h3>Patient</h3>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-11 mx-auto">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:TextBox CssClass="form-control" placeholder="Medical condition of the patient" ID="DescriptionTextBox" TextMode="MultiLine" runat="server"></asp:TextBox>
                                </div>
                                <div class="form-group">
