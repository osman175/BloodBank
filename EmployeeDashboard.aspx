<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EmployeeDashboard.aspx.cs" Inherits="BloodBank.EmployeeDashboard" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="NavBarPlaceHolder" runat="server">
    <li class="nav-item">
        <a class="nav-link" href="EmployeeDashboard.aspx">Dashboard</a>
    </li>
</asp:Content>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-7 mx-auto text-center">
                <h1>Welcome <asp:Label ID="EmployeeNameLabel" runat="server" Text="Label"></asp:Label></h1>
                <div class="row mt-3">
                    <div class="col">
                        <h2><asp:Label ID="TransfersLabel" runat="server" Text="-1"></asp:Label></h2>
